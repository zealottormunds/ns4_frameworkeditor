...
Vector3 FileParser::b_ReadVector3(std::vector<BYTE> actual, int index)
{
	Vector3 v = Vector3();

	v.x = b_ReadFloat(actual, index);
	v.y = b_ReadFloat(actual, index + 4);
	v.z = b_ReadFloat(actual, index + 8);
...
std::vector<BYTE> FileParser::b_AddVector3(std::vector<BYTE> actual, Vector3 v)
{
	vector<BYTE> a = actual;

	a = b_AddFloat(actual, v.x);
	a = b_AddFloat(actual, v.y);
	a = b_AddFloat(actual, v.z);
...
bool FileParser::FileExists(string _file)
{
