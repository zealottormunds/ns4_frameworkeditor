...
public:
	...
	static Vector3 b_ReadVector3(std::vector<BYTE> actual, int index);
	...
	static std::vector<BYTE> b_AddVector3(std::vector<BYTE> actual, Vector3 v);
	...
	static bool FileExists(std::string _file);
